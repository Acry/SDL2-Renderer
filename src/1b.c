...
SDL_SetWindowTitle(Window, "RenderCopyEx - Rotate");
...
while(running){
	...
	SDL_RenderCopyEx(Renderer, logo, NULL, &logo_dst, a, NULL, 0);
	// Rotation Center:
	// Address of a point indicating the pivot-point/origin around which
